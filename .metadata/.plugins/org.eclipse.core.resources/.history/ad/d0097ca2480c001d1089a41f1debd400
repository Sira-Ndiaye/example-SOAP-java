 ...
 * 
 */
@WebServiceClient(name = "UserServicesService", targetNamespace = "http://domaine/", wsdlLocation = "http://localhost:10254?wsdl")
public class UserServicesService
    extends Service
{

    private final static URL USERSERVICESSERVICE_WSDL_LOCATION;
    private final static WebServiceException USERSERVICESSERVICE_EXCEPTION;
    private final static QName USERSERVICESSERVICE_QNAME = new QName("http://domaine/", "UserServicesService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:10254?wsdl");
        } catch (MalformedURLException ex) {
            e = new WebServiceException(ex);
        }
        USERSERVICESSERVICE_WSDL_LOCATION = url;
        USERSERVICESSERVICE_EXCEPTION = e;
    }
    ...
    public UserServices getUserServicesPort() {
        return super.getPort(new QName("http://domaine/", "UserServicesPort"), UserServices.class);
    }
    ...
    public UserServices getUserServicesPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://domaine/", "UserServicesPort"), UserServices.class, features);
    }
